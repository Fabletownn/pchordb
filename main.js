...
client.on('message', message => {
    ...
    PRE.findOne({
        ...
        if (message.guild.id === "797142251712151583" && (message.content.startsWith(`${commandPrefix}`) && !message.content.startsWith(`${commandPrefix}purge`) && !message.content.startsWith(`${commandPrefix}ping`) && !message.content.startsWith(`${commandPrefix}announce`) && !message.content.startsWith(`${commandPrefix}say`) && !message.content.startsWith(`${commandPrefix}assistance`) && !message.content.startsWith(`${commandPrefix}slowmode`) && !message.content.startsWith(`${commandPrefix}mcserverinfo`) && !message.content.startsWith(`${commandPrefix}mcrules`) && !message.content.startsWith(`${commandPrefix}fetchbans`) && !message.content.startsWith(`${commandPrefix}mccolorlock`))) return;
