...
client.on('voiceStateUpdate', (oldState, newState) => {
    ...
    if (oldUserChannel === undefined && newUserChannel !== undefined) {
        if (newUserChannel.id === "774362075618869270") {
            const voiceChannel = newState.guild.channels.cache.get('789056873437331456');
        ...
        } else if (newUserChannel.id === "614484127722373120") {
        ...
        } else if (newUserChannel.id === "757301388840665248") {
        ...
        } else if (newUserChannel.id === "664593167420489730") {
        ...
        } else if (newUserChannel.id === "744952618878763088") {
    ...
    if (newUserChannel === undefined) {
        if (oldUserChannel.id === "774362075618869270") {
        ...
        } else if (oldUserChannel.id === "614484127722373120") {
        ...
        } else if (oldUserChannel.id === "757301388840665248") {
        ...
        } else if (oldUserChannel.id === "664593167420489730") {
        ...
        } else if (oldUserChannel.id === "744952618878763088") {
