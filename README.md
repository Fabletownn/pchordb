...
- Please do not attempt to intercept, recreate or reenact this application without the proper permission from the owner(s).
...
- You may be able to see some crucial information going through the commit history of a few files: this was, once again, done purposely. **This information has since been changed and proper procedures have been taken to ensure the security of said application(s).**
...
- You are able to use some code from this GitHub repository for your own personal/public application(s)- that is OK: however, the attempt of recreating this bot entirely using this source code **is not**.
