...
module.exports = {
    name: 'ahelp',
    description: '[GENERAL] This will provide you the list of commands, their aliases, and how to use them **all at once**. <[setPrefix]help>',
