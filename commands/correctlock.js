...
module.exports = {
    ...
    execute(message, args) {
        ...
        if (message.channel.id !== '711435929537085450') return;

        message.guild.channels.cache.get('711435929537085450').messages.fetch('784498616970117162').then(m => {
            const correctionEmbed = {
                "title": "Color Lock",
