...
module.exports = {
    ...
    async execute(message, commandPrefix) {
        ...
        message.channel.send(`**[🕹️] ${message.author.username}**, let's play **Jumble**! Your jumbled word will be shown shortly. __Get ready!__`).then(msg => {
            setTimeout(async function() {
                await msg.edit(`**[🕹️] ${message.author.username}**, your jumbled word is **${word[0].jumble}**!\n**You have 15 seconds to answer. If you do not answer in time, the game will timeout.**\n\nHINT: ||starts with "${hint}"||`);
