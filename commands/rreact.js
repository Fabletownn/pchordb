...
module.exports = {
    ...
    execute(message, args) {
        ...
        const toID = message.content.split("rreact ");
        ...
        if (!grantID) return message.channel.send(`**[😄] ${message.author.username}**, please either: mention a member or role __OR__ provide a member's ID or role to revoke \`ADD_REACTIONS\` permissions from.`).then(m => m.delete({
            timeout: 10000
        }));
        ...
        if (toGrant) {
            ...
            const grantedEmbed = new Discord.MessageEmbed()
                .setDescription(`Revoked reaction permissions from <@${toGrant.id}> in channels under the \`I TALK GENERAL\` and \`I TALK FORTNITE\` categories.\n\n*(This action has been recorded in the Audit Logs.)*`)
                .setColor('ff0000')
            ...
            const grantedEmbed = new Discord.MessageEmbed()
                .setDescription(`Revoked reaction permissions from <@&${toGrantR.id}> in channels under the \`I TALK GENERAL\` and \`I TALK FORTNITE\` categories.\n\n*(This action has been recorded in the Audit Logs.)*`)
                .setColor('ff0000')
            ...
            if (message.guild.roles.cache.find(role => role.id === grantID)) {
                ...
                const grantedEmbed = new Discord.MessageEmbed()
                    .setDescription(`Revoked reaction permissions from <@&${grantID}> in channels under the \`I TALK GENERAL\` and \`I TALK FORTNITE\` categories.\n\n*(This action has been recorded in the Audit Logs.)*`)
                    .setColor('ff0000')
